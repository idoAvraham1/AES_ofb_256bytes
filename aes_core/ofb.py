...
def aes_ofb_encrypt(key, iv, plaintext):
    ...
    # Process the plaintext in 16-byte chunks
...
def aes_ofb_decrypt(key, iv, ciphertext):
    """
    Decrypts ciphertext using AES-256 in OFB mode.

    OFB mode decryption is identical to encryption:
    - The same keystream is generated by encrypting the IV and feedbacks.
    - The ciphertext is XORed with the keystream to recover the plaintext.
    """
